...
public class PromptManager {
    ...
    public String createChildStateAnalysisPrompt(Status currentStatus, List<Note> notes) {
        ...
        return promptTemplate.fillTemplate(
                        ...
                        - 감각 민감도는 기존 횟수에 새로운 노트에서 관찰된 민감 반응을 추가하여 누적 계산해주세요.
                        - 새로운 노트에서 특정 감각에 대한 예민한 반응이 관찰되면 해당 감각 횟수에 +1씩 추가하세요:
                         * 청각: 큰 소리, 특정 소리에 놀라거나 거부 반응
                         * 시각: 밝은 빛, 깜빡임, 특정 색상에 과민 반응
                         * 촉각: 특정 질감, 온도, 접촉을 피하거나 거부
                         * 후각: 특정 냄새에 강한 반응이나 거부감
                         * 미각: 특정 맛, 음식 질감에 거부 반응
                         * 사회적: 사람들과의 접촉, 시선, 사회적 상황에 스트레스 반응
                ...
                """
                        {
                          ...
                          "hearingSensitivity": 누적 관찰 횟수(정수),
                          "sightSensitivity": 누적 관찰 횟수(정수),
                          "touchSensitivity": 누적 관찰 횟수(정수),
                          "smellSensitivity": 누적 관찰 횟수(정수),
                          "tasteSensitivity": 누적 관찰 횟수(정수),
                          "socialSensitivity": 누적 관찰 횟수(정수)
                        }
                        """
        );
    }
